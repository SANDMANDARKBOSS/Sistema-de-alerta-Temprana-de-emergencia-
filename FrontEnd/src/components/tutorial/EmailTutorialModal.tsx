          ...
          <div className="space-y-8">
            ...
            <div>
              <div className="flex items-center gap-3 mb-3">
                <span className="w-6 h-6 rounded-full bg-blue-100 text-[#1565C0] text-xs font-bold flex items-center justify-center">1</span>
            ...
            <div>
              <div className="flex items-center gap-3 mb-3">
                <span className="w-6 h-6 rounded-full bg-blue-100 text-[#1565C0] text-xs font-bold flex items-center justify-center">2</span>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-end gap-3">
                      <div className="flex-1">
                        <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1">Correo Hospital</label>
                        <input type="text" readOnly value="hospital_demo@yopmail.com" className="w-full bg-white border border-gray-200 rounded-lg px-4 py-2.5 text-gray-700 outline-none" />
                      </div>
                      <button 
                    ...
                    <div className="flex items-end gap-3">
                      <div className="flex-1">
                        <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1">Correo Aseguradora (Gestor)</label>
                        <input type="text" readOnly value="seguro_demo@yopmail.com" className="w-full bg-white border border-gray-200 rounded-lg px-4 py-2.5 text-gray-700 outline-none" />
                      </div>
                      <button 
                    ...
                    <div className="flex items-end gap-3">
                      <div className="flex-1">
                        <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1">Correo de Pacientes (Asegurados)</label>
                        <select 
